...
export function GroupNavigation() {
  ...
  const hasAdvisorAccess =
    hasManagementAccess || isSupervisor(currentGroup.id) || isAdvisor(currentGroup.id)
  ...
  return (
    <>
      ...
      <NavLink label='Dashboard' component='a' href={`/groups/${currentGroup.slug}/dashboard`} />

      {hasAdvisorAccess && (
        <>
          <NavLink label='Topics' component='a' href={`/groups/${currentGroup.slug}/topics`} />
          <NavLink
            label='Applications'
            component='a'
      ...
      {hasManagementAccess && (
        <NavLink label='Group Settings' component='a' href={`/groups/${currentGroup.slug}/edit`} />
      )}
      ...
      <Menu position='bottom-start'>
        ...
        <Menu.Dropdown>
          <Menu.Item onClick={() => navigate('/groups')}>Select Another Group</Menu.Item>
        </Menu.Dropdown>
      </Menu>
    </>
  )
