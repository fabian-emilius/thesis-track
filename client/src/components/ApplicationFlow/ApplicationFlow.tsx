  ...
  return (
    <Container size='xl'>
      <Stepper active={active} onStepClick={setActive}>
        ...
        <Stepper.Step label='Personal Information' description='Your details' disabled={!groupId}>
          <StudentInformationStep onComplete={nextStep} onBack={prevStep} />
        </Stepper.Step>

        <Stepper.Step label='Select Topic' description='Choose a thesis topic' disabled={!groupId}>
          <SelectTopicStep onComplete={nextStep} onBack={prevStep} />
        </Stepper.Step>

        <Stepper.Step label='Motivation' description='Write your motivation' disabled={!groupId}>
