...
export const GroupSelectionStep: React.FC<GroupSelectionStepProps> = ({ onComplete }) => {
  ...
  if (userGroups.length === 0) {
    return (
      <Text c="dimmed">
        No groups are currently available for applications.
      </Text>
    );
  }
  ...
  return (
    <Stack>
      <Text size="sm" c="dimmed">
        Select a group to apply for a thesis. Each group may have different requirements and available topics.
      </Text>
